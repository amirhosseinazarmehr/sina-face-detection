...
- `EmployeeDetailScreen` – shows an employee's status with a simulated camera preview and logs. Includes an autocomplete search bar to quickly select an employee.
...
Make sure the tailwind config includes the `nativewind` preset for compatibility.
